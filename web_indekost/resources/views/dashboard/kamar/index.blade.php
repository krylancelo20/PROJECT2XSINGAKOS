                ...
                <tbody>
                    @foreach ($kost as $k)
                        <tr>
                            ...
                            <td>{{ $k->alamat }}</td>
                            <td>
                                <a href="/dashboard/kost/{{ $k->id }}" class="btn btn-success"><i
                                        class="bi bi-eye"></i></a>
                                <a href="/dashboard/kost/{{ $k->id }}/edit" class="btn btn-warning"><i
                                        class="bi bi-pencil"></i></a>
                                <form action="/dashboard/kost/{{ $k->id }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
